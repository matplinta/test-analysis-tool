...
class RepPortal():
    ...
    def __init__(self):
        ...
        self.basic_param_list = ['qc_test_set', 'test_case__name', 'configuration', 'result', 'builds', 'fail_message', 'end']
    ...
    def get_data_and_filter(self, filter_dict, limit=30, param_list=None):
